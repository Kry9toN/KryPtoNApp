...
import com.krypton.kernelmanager.activities.BannerResizerActivity;
import com.krypton.kernelmanager.activities.MainActivity;
import com.krypton.kernelmanager.activities.NavigationActivity;
import com.krypton.kernelmanager.services.boot.ApplyOnBootService;
import com.krypton.kernelmanager.utils.AppSettings;
import com.krypton.kernelmanager.utils.Themes;
import com.krypton.kernelmanager.utils.AppUpdaterTask;
...
import com.krypton.kernelmanager.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                RootUtils.runCommand("rm -rf /data/.kernelmanager");
                RootUtils.runCommand("pm clear com.krypton.kernelmanager");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.kernelmanager");
                RootUtils.runCommand("pm clear com.krypton.kernelmanager && reboot");
            });
            alert2.show();
        });
        alert.show();
