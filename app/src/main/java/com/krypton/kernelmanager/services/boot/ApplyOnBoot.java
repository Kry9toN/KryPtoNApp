 ...
 *
 */
package com.krypton.kernelmanager.services.boot;
...
import com.krypton.kernelmanager.utils.NotificationId;
...
import com.krypton.kernelmanager.utils.root.RootFile;
    ...
    public static boolean apply(ApplyOnBootService service, final ApplyOnBootListener listener) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RootUtils.runCommand("setprop kernelmanager.applied_onboot 1");
            }
        }).start();
        return true;
    }
