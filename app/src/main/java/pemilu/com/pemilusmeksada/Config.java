...
public class Config {
    ...
    public static final String LOGIN_URL = SERVER_URL+"pilketosmeksada/user/login.php";
    public static final String VOTE_URL = SERVER_URL+"pilketosmeksada/user/vote_kandidat.php";
    public static final String KANDIDAT_URL = SERVER_URL+"pilketosmeksada/user/select_data.php?id=";
    public static final String VIDEO_URL = SERVER_URL+"pilketosmeksada/user/video-kandidat/";
    public static final String URL_PHOTOS_USERS = SERVER_URL+"pilketosmeksada/user/img/" ;
